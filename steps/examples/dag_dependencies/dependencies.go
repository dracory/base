...
func NewDataStep() steps.StepInterface {
	step := steps.NewStep()
...
func NewProcessStep() steps.StepInterface {
	step := steps.NewStep()
...
func NewSumStep() steps.StepInterface {
	step := steps.NewStep()
...
func NewDependenciesDag() steps.DagInterface {
	dag := steps.NewDag()
