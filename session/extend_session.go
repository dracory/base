...
// ExtendSession extends an authenticated session by the specified number of seconds.
// It validates that the session IP address and user agent match the current request
// before extending the session expiration time.
