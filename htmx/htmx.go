...
func IsHxBoosted(r *http.Request) bool {
	value := strings.TrimSpace(r.Header.Get("HX-Boosted"))
	return value == "true"
}
...
func IsHxHistoryRestoreRequest(r *http.Request) bool {
	value := strings.TrimSpace(r.Header.Get("HX-History-Restore-Request"))
	return value == "true"
}
...
func IsHxTrigger(r *http.Request) bool {
	value := strings.TrimSpace(r.Header.Get("HX-Trigger"))
	return value == "true"
}
...
func HxPrompt(r *http.Request) string {
	return strings.TrimSpace(r.Header.Get("HX-Prompt"))
}
...
func HxTriggerName(r *http.Request) string {
	return strings.TrimSpace(r.Header.Get("HX-Trigger-Name"))
}
